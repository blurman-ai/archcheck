...
4. Для diff path не нужен hunk parser:
   достаточно `git::changedCppFiles()` из [src/git/git_state.cpp](/home/localadm/projects/cpparch/src/git/git_state.cpp),
...
7. Тесты:
   ...
   1-2 compare сценария в [tests/integration/diff/git_diff_test.cpp](/home/localadm/projects/cpparch/tests/integration/diff/git_diff_test.cpp), чтобы проверить работу через реальные refs.
