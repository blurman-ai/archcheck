...
`/home/localadm/oss/_aidev_state/` (на ext4, переживает reboot в Windows).
...
Стейт (не в git, persistent): `/home/localadm/oss/_aidev_state/`. Cron: `/etc/cron.d/airepo_resume`.
