...
|------|-----------|--------|
| `docs/architecture-spec.md` | главный — рефакторинг по разделам, версия → v2.1 | (pending: версия) |
| `docs/architecture-spec.md` | шаг 5: раздел «двух-бекендная схема» → принятое решение; bullet «Парсинг» обновлён | pending |
...
| `docs/MVP.md` | сверить с новым v0.1 cover-story; возможно небольшие правки | — |
