...
**Следующий шаг:** Slice 2 — привести runtime к контрактам + изолировать placeholder/no-op
(`src/scan/duplication/fp_corpus_eval.cpp`, `phase12HeaderImplGate()`); проверить reporters на отсутствие `column`.
