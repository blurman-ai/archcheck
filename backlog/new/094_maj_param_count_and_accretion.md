...
4. `ARG.4.parameter_accretion` строить через compare двух снимков по changed files:
   ...
   baseline side читать через `GitObjectFileSource` из [src/git/git_object_file_source.cpp](/home/localadm/projects/cpparch/src/git/git_object_file_source.cpp);
...
7. Тесты привязать к уже существующим entry points:
   ...
   git/ref scenarios — расширение [tests/integration/diff/git_diff_test.cpp](/home/localadm/projects/cpparch/tests/integration/diff/git_diff_test.cpp).
