...
7. Тесты привязать к уже имеющемуся git infrastructure:
   ...
   при необходимости end-to-end сценарии пока можно добавить в [tests/integration/diff/git_diff_test.cpp](/home/localadm/projects/cpparch/tests/integration/diff/git_diff_test.cpp), чтобы не плодить вторую temp-repo harness раньше времени.
