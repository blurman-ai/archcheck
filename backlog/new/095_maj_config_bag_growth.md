...
**Блокирует:** —
**Заблокирован:** —
**Related:** #018 (git_diff_analysis), #030 (baseline_file_flag), #051 (config_loader_v1), #075 (trusted_diff_workflow), #089 (boolean_state_drift), #093 (flag_argument), #094 (param_count_and_accretion)
...
6. Не трогать [src/config/config_loader.cpp](/home/localadm/projects/cpparch/src/config/config_loader.cpp):
...
7. Тесты разложить так:
   ...
   при необходимости 1-2 end-to-end compare сценария в [tests/integration/diff/git_diff_test.cpp](/home/localadm/projects/cpparch/tests/integration/diff/git_diff_test.cpp).
