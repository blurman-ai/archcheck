...
1. Переиспользовать или, если ещё не landed, создать shared text preprocessing слой:
   ...
   База для него уже фактически сидит в [src/scan/include_scanner.cpp](/home/localadm/projects/cpparch/src/scan/include_scanner.cpp): stripping comments/raw strings, identifier helpers, line mapping.
