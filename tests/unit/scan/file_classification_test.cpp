...
TEST_CASE("hasGeneratedHeader: name-independent generated/copied banners (#127)", "[scan][generated]")
{
  ...
  REQUIRE(hasGeneratedHeader("// A Bison parser, made by GNU Bison 3.8.2.\n"
                             "// Skeleton implementation for Bison LALR(1) parsers in C++\n"));
  REQUIRE(hasGeneratedHeader("// A Bison parser, made by GNU Bison 3.8.2.\n"
                             "// Skeleton interface for Bison LALR(1) parsers in C++\n"));
  REQUIRE(hasGeneratedHeader("/* A lexical scanner generated by flex */\n#define FLEX_SCANNER\n"));
  REQUIRE(hasGeneratedHeader("/* This file was automatically generated by SWIG (https://www.swig.org). */\n"));
  ...
  REQUIRE_FALSE(hasGeneratedHeader("// Hand-written parser for Bison files and Flex rules.\n"));
