...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 5 include-циклов, крупнейший SCC=6. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/AztecProtocol_aztec-packages`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=22. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/deskull-m_bakabakaband`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 11 include-циклов, крупнейший SCC=14. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/ericflo_kiln`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 4 include-циклов, крупнейший SCC=8. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/GregorGullwi_FlashCpp`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/AlchemyViewer_Alchemy`

### `089faea959a6` — "Update velopack to 1.1.1" (Rye, 2026-05-31) [30 hits]
  inspect: `git -C ~/oss/_aidev_dense/AlchemyViewer_Alchemy show 089faea959a6`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/CrispStrobe_CrispASR`
...
### `9d259a9eac26` — "docs: finalize funasr CUDA §136 — v16 confirmed, full investigation writeup" (crispasr integration, 2026-06-01) [7 hits]
  inspect: `git -C ~/oss/_aidev_dense/CrispStrobe_CrispASR show 9d259a9eac26`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/Krilliac_SparkEngine`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/NamecoinGithub_LLL-TAO`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/winnerspiros_UnleashedRecomp_Android`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/BALL-Project_ball`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/graphillion_kyotodd`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/ayutaz_piper-plus`
...
### `b7bd573aaaf8` — "Add plugin hint" (Bob Jansen, 2026-05-31) [25 hits]
  inspect: `git -C ~/oss/_aidev_dense/bobjansen_Ibex show b7bd573aaaf8`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/HendrikGC02_Astroray`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 10 include-циклов, крупнейший SCC=13. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/brontoguana_krasis`

## csgaokun/vscode_claude — 571 коммитов | циклы=1(SCC≤2) | копипаст=0
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/csgaokun_vscode_claude`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=4. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/cschladetsch_CppKAI`
...
### `329dd50cc36c` — "Fix #100: Add signed/unsigned variants for MUL and fix right shift operators" (Craig Taylor, 2026-05-31) [5 hits]
  inspect: `git -C ~/oss/_aidev_dense/CTalkobt_M65Compiler show 329dd50cc36c`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 4 include-циклов, крупнейший SCC=6. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/starseeker_obol`
...
### `469ad9a7d8bf` — "Merge pull request #186 from ErenAri/fix/aegis-next-arena-redefinition" (Eren Arı, 2026-06-01) [2 hits]
  inspect: `git -C ~/oss/_aidev_dense/ErenAri_Aegis-BPF show 469ad9a7d8bf`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 3 include-циклов, крупнейший SCC=5. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/andrewnakas_Boxedwine64`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/FLOX-Foundation_flox`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/cwida_privacy`
...
### `8ed9af78e53f` — "Merge pull request #100 from joshualongenecker/updateDefault" (Joshua Longenecker, 2026-04-25) [4 hits]
  inspect: `git -C ~/oss/_aidev_dense/joshualongenecker_home-assistant-bridge-esphome show 8ed9af78e53f`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 3 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/Arsia-Mons_Silencer`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/El-EnderJ_NeoCalculator`
...
### `7a1a415a1405` — "docs: Add comprehensive migration guide for NumOS to STIX Two Math and a little head start" (El-EnderJ, 2026-05-30) [1 hits]
  inspect: `git -C ~/oss/_aidev_dense/El-EnderJ_NeoCalculator show 7a1a415a1405`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/remiserriere_AI-on-the-edge-device`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/ismobaga_izilang`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=4. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/DavidLee18_DArc`

## X4V1-code/Xorion — 171 коммитов | циклы=3(SCC≤3) | копипаст=76
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 3 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/X4V1-code_Xorion`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=60. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/grahame-org_ohal`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 18 include-циклов, крупнейший SCC=5. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/victorwitkamp_XePCI`

## o9nn/ATenSpace — 98 коммитов | циклы=1(SCC≤7) | копипаст=0
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=7. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/o9nn_ATenSpace`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/supaplextor_aqemu`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/onouh_FibonacciHeap`
...
### `321928f611c0` — "Merge pull request #10 from deramatamara-lab/copilot/elevate-ui-to-production-grade" (deramatamara-lab, 2025-12-03) [15 hits]
  inspect: `git -C ~/oss/_aidev_dense/deramatamara-lab_cppmusic show 321928f611c0`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 3 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/Zero3K20_hpsx64`

## ReZorg/plingua — 52 коммитов | циклы=2(SCC≤3) | копипаст=0
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/ReZorg_plingua`

## RegimA-Zone/RRR-P-Systems — 52 коммитов | циклы=2(SCC≤3) | копипаст=0
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/RegimA-Zone_RRR-P-Systems`

## Autonomy-Logic/matiec — 52 коммитов | циклы=2(SCC≤2) | копипаст=21
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/Autonomy-Logic_matiec`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/RegimA-Zone_skin9ml`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=9. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/DavidBechtold_MIPSCore`

## shadow11001/esphome — 41 коммитов | циклы=2(SCC≤3) | копипаст=16
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/shadow11001_esphome`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/santzit_go-guitar2`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/cogcities_rrp9-civic-angel`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 3 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/awest813_Dewm-3`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/ZoneCog_RRR-P-Systems`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 4 include-циклов, крупнейший SCC=5. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/andrele_perse_rover-firmware-microros`
...
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 2 include-циклов, крупнейший SCC=3. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/HyperCogWizard_rrpling`

## o6nn/kactl — 30 коммитов | циклы=1(SCC≤2) | копипаст=8
- **СТРУКТУРНЫЙ ДРЕЙФ (надёжно):** 1 include-циклов, крупнейший SCC=2. `~/projects/cpparch/build/debug/src/archcheck --graph ~/oss/_aidev_dense/o6nn_kactl`
...
### `d561b1dc6058` — "Merge pull request #7 from Scynode/copilot/fix-build-errors-after-translation" (Scynode, 2026-03-07) [37 hits]
  inspect: `git -C ~/oss/_aidev_dense/Scynode_PhantomFirmware show d561b1dc6058`
