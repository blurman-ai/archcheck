...
set -u
POOL=~/projects/cpparch/experiments/ai_repo_run/lowstar_pool.tsv
ROOT=~/oss/_aidev_lowstar
N="${1:-20}"            # реп на бакет
MAXKB=500000            # 500 MB
LOG=~/projects/cpparch/experiments/ai_repo_run/clone_lowstar.log
TSV=~/projects/cpparch/experiments/ai_repo_run/corpus_lowstar.tsv
mkdir -p "$ROOT"
: > "$LOG"
