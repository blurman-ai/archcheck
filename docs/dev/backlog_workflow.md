...
См. [`/home/localadm/projects/gm/docs/wip/521_rmi_crash.md`](/home/localadm/projects/gm/docs/wip/521_rmi_crash.md) — `521` это Bitbucket issue ID, файл — depth-layer: таймлайн, стек-трейсы, гипотезы, «следующие шаги». В Bitbucket-тикете только статус + краткий апдейт.
